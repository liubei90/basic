...
.el-carousel .el-carousel__indicators--vertical {
  right: 0;
  top: 50%;
  transform: translateY(-50%);
}
...
.el-carousel .el-carousel__indicators--outside .el-carousel__indicator:hover button {
  opacity: 0.64;
}
...
.el-carousel .el-carousel__indicators--labels {
  left: 0;
  right: 0;
  transform: none;
  text-align: center;
